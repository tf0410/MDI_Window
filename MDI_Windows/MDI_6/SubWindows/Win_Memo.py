...
from PyQt6.QtWidgets import QApplication, QFileDialog, QMessageBox, QTextEdit
from PyQt6.QtCore import QFile, QFileInfo, QTextStream, Qt, QFileDevice
...
class MdiChild(QTextEdit):
    ...
    def loadFile(self, fileName):
        ...
        if not file.open(QFileDevice.OpenModeFlag.ReadOnly | QFileDevice.OpenModeFlag.Text):
