...
from PyQt6.QtWidgets import (QWidget, QGroupBox, QRadioButton, 
                             QCheckBox, QPushButton, QMenu, QGridLayout, QVBoxLayout)



class sub_win1(QWidget):
    def __init__(self):
        super(sub_win1, self).__init__()
    ...
    def initUI(self):
        ...
        # self.show()
        # 화면 종료시 MDiArea 에서 Widget을 제거하여 메뉴를 다시 선택 시 다시 Open 되도록 한다.
